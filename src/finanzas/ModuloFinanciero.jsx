      ...
      {vista === 'movimientos' ? (
        ...
        <>
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Distribucion del ingreso: fila propia, horizontal de extremo a
                extremo -- ya no comparte fila con Independencia (eso la
                estiraba a una columna angosta y altisima). */}
...
export default function ModuloFinanciero() {
  return (
    <div className="min-h-screen w-full bg-[#0A0A0A] font-body text-[#E5E5E5]">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&family=Inter:wght@300;400;500&family=IBM+Plex+Mono:wght@400;500&display=swap');
