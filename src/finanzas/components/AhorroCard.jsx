  ...
  return (
    <div className="rounded-2xl p-5 border border-[#1A1A1A] bg-[#141414] flex flex-col">
      <span className="text-[15px] font-display text-[#9A9AA0] flex items-center gap-1.5">
        <ShieldCheck size={14} /> Ahorro (fondo emergencia)
      </span>

      <div className="flex items-end justify-between mt-3">
        <div>
          <p className="font-display text-[29px] font-light text-[#F2F2F2] leading-none">{formatMoney(ahorro.real)}</p>
          <p className="text-[12.5px] text-[#5A5A5A] mt-1.5 font-mono">de {formatMoney(ahorro.plan)} planificados</p>
        </div>
        <p className="font-mono text-[17px]" style={{ color }}>
      ...
      <div className="flex justify-between mt-4 pt-3 border-t border-[#1E1E1E] text-[12px] font-mono text-[#75757A]">
