...
export default function SaldoDisponibleCard() {
  ...
  return (
    <div className="relative rounded-2xl p-6 sm:p-7 border border-[#1A1A1A] bg-[#141414] overflow-hidden">
      <div
      ...
      <div className="relative flex items-start justify-between gap-4 flex-wrap">
        <div>
          <span className="text-[15px] font-display font-normal text-[#9A9AA0]">Saldo disponible</span>
