      ...
      <div className="relative flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <div className="flex items-baseline gap-1 mt-2 flex-wrap">
            <span className="font-display text-[46px] sm:text-[56px] font-semibold leading-none text-[#3B82F6] tracking-tight">$</span>
            <span className="font-display text-[46px] sm:text-[56px] font-semibold leading-none text-[#F2F2F2] tracking-tight">
