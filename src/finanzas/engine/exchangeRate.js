...
// Periodos disponibles para las graficas de USD/COP (punto 2). La TRM se
// publica UNA vez por dia habil -- no existe granularidad intradia sin una
// fuente de pago/backend adicional (ver nota en el componente). Por eso
// "1 dia" y "5 dias" muestran los ultimos registros diarios disponibles, no
// datos por hora -- es una limitacion real de la fuente, no un error.
export const PERIODOS_TASA = [
  { key: '1d', label: '1 dia', limite: 2 },
  { key: '5d', label: '5 dias', limite: 5 },
  { key: '1m', label: '1 mes', limite: 22 },
  { key: '3m', label: '3 meses', limite: 65 },
  { key: '6m', label: '6 meses', limite: 130 },
  { key: '1a', label: '1 año', limite: 252 },
];
